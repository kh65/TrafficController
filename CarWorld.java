...
class CarWorld extends JPanel {
    ...
    public CarWorld() {
       ...
       //	controller = new TrafficControllerFair(new TrafficRegistrarEmpty());
        ...
        redCar = toolkit.getImage("C:/Users/kejsi/eclipse-workspace/TrafficControllerPLC19WS.zip_expanded/TrafficControllerPLC19WS/image/redcar.gif");
        mt.addImage(redCar, 0);
        blueCar = toolkit.getImage("C:/Users/kejsi/eclipse-workspace/TrafficControllerPLC19WS.zip_expanded/TrafficControllerPLC19WS/image/bluecar.gif");
        mt.addImage(blueCar, 1);
        bridge = toolkit.getImage("C:/Users/kejsi/eclipse-workspace/TrafficControllerPLC19WS.zip_expanded/TrafficControllerPLC19WS/image/bridge.gif");
